...
public class TencetCloudAPITC3 {
    private static String SecretId  = "AKIDCCxReaFdkbBVYKoxpQknZ4IEuJRItCEz";
    private static String SecretKey = "cx1oKZXEeohJdhV2HFwMVNzJM8etrXx6";
    ...
    public static void main(String [] args) {
        ...
        params.put("PersonId","827");
        params.put("Url", "https://iai-temp-1254418846.cos.ap-guangzhou.myqcloud.com/" +
                "c32f5fc8-9060-41a1-b61d-68aac52d0c6f?" +
                "q-sign-algorithm=sha1&" +
                "q-ak=AKIDz0lGTwk6lAAuPeNOdcoCk6C3e07wPnqd&" +
                "q-sign-time=1632363848;1632365648&" +
                "q-key-time=1632363848;1632365648&" +
                "q-header-list=&q-url-param-list=&" +
                "q-signature=920499d1f2f7b1eb0e2c04e92542f6fa7ccb141d");


        Gson gson = new Gson();
        String param = gson.toJson(params);
        //发送请求 本地封装的https 请求
        String response = getAuthTC3("VerifyFace", param, Version);
        //打印请求数据
